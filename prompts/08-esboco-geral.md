...
**Localização no trabalho:** Seção 3.1.6 — Esboço Geral

## O que este prompt gera
Um esboço (outline) estruturado de todo o livro bíblico em estudo, em formato de tópicos hierárquicos (algarismos romanos, letras maiúsculas), mostrando como os comentaristas dividem o livro em grandes blocos e subseções.

## Fontes recomendadas para esta seção
Comentários bíblicos com esboços estruturais do livro, introduções ao Antigo/Novo Testamento, panoramas bíblicos.
...
Caso mais de uma fonte traga esboços distintos do livro, apresente o esboço da fonte que for mais detalhada ou mais amplamente referenciada, e mencione brevemente, em nota, se outras fontes propõem uma divisão diferente.
