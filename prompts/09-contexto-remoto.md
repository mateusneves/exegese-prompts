...
**Localização no trabalho:** Seção 3.2.1 — Contexto Remoto

## O que este prompt gera
Uma visão panorâmica de como a perícope se relaciona com o livro inteiro: em qual grande bloco temático ela se encaixa e como esse bloco se conecta com as demais grandes seções do livro.

## Fontes recomendadas para esta seção
Comentários bíblicos (especialmente introduções aos grandes blocos do livro), o esboço geral já produzido no prompt "08-esboco-geral".
